...
(function() {
    ...
    function E(a) {
        return P(a.replace(/^['"](.*)['"]$/, "$1")).replace(/^\s+|\s+$/g, "")
    }
    function B(a, c) {
        for (var b = 0, d = 0, e = jSmart.prototype.left_delimiter, f = jSmart.prototype.right_delimiter, g = jSmart.prototype.auto_literal, l = /^\s*(.+)\s*$/i, l = a ? RegExp("^\\s*(" + a + ")\\s*$", "i") : l, k = 0; k < c.length; ++k)
            if (c.substr(k, e.length) == e)
                g && k + 1 < c.length && c.substr(k + 1, 1).match(/\s/) || (b || (c = c.slice(k),
                d += parseInt(k),
                k = 0),
                ++b);
            else if (c.substr(k, f.length) == f && !(g && 0 <= k - 1 && c.substr(k - 1, 1).match(/\s/))) {
                if (!--b) {
                    var h = c.slice(e.length, k).replace(/[\r\n]/g, " ").match(l);
                    if (h)
                        return h.index = d,
                        h[0] = c.slice(0, k + f.length),
                        h
                }
                0 > b && (b = 0)
            }
    ...
    function Q(a, c, b) {
        ...
        do {
            ...
            (f = B(c, d)) && (d = d.slice(f.index + f[0].length))
        } while (f);e.index = g;
        return e
    }
    function K(a, c, b, d) {
        for (var e = 0, f = B(b, d); f; f = B(b, d)) {
            var g = B(a, d);
    ...
    function r(a, c) {
        for (var b = B("", a); b; b = B("", a)) {
            
            b.index && w(a.slice(0, b.index), c);
            ...
            if (d) {
                ...
                if (e in F) {
                    var f = F[e]
                      , d = ("parseParams"in f ? f.parseParams : z)(d);
                    ...
                    a = a.slice(b.index + b[0].length)) : "function" == b.type && (b = z(d),
                    c.push({
                        type: "plugin",
                        name: e,
                        params: b
                    ...
                    F.expression.parse(b[1], c)
            } else
                e = F.expression.parse(b[1], c),
        ...
        if (!u.stop) {
            ...
            if (b) {
                ...
                for (var b = [], e = a.match(/^\s*:\s*/); e; e = a.match(/^\s*:\s*/))
                    ...
                    T(a, e) ? (c.value += e.value,
                    b.push(e.tree[0]),
                    a = a.slice(e.value.length)) : w("", b);
                u.stop = !1;
    ...
    function T(a, c) {
        ...
        for (b = 0; b < L.length; ++b)
            if (a.match(L[b].re))
                ...
                L[b].parse(c, a.slice(c.token.length)),
                !0;
        return !1
    }
    function Z(a, c, b) {
    ...
    function C(a, c, b) {
        for (var d = c, e = "", f = 0; f < a.parts.length; ++f) {
            ...
            if ("plugin" == g.type && "__func" == g.name && g.hasOwner)
                ...
                e = p([g], c);
                e in c.smarty.section && "text" == g.type && "smarty" != p([a.parts[0]], c) && (e = c.smarty.section[e].index);
        ...
        for (var b = "", d = 0; d < a.length; ++d) {
            ...
            if ("text" == f.type)
                ...
                if ("block" == g.type) {
                    ...
                    for (g.process(y(f.params, c), "", c, l); l.value; )
                        l.value = !1,
                        e += g.process(y(f.params, c), p(f.subTree, c), c, l)
                } else
                    "function" == g.type && (e = g.process(y(f.params, c), c))
            }
    ...
    function aa(a, c, b) {
        if (!b && a in V)
            ...
            b = jSmart.prototype.getTemplate(a);
            if ("string" != typeof b)
                throw Error("No template for " + a);
            r(M(jSmart.prototype.filters_global.pre, ba(b.replace(/\r\n/g, "\n"))), c);
            V[a] = c
        }
        return c
    }
    function ba(a) {
        for (var c = "", b = a.match(/{\*/); b; b = a.match(/{\*/)) {
            c += a.slice(0, b.index);
            a = a.slice(b.index + b[0].length);
            b = a.match(/\*}/);
            if (!b)
    ...
    var F = {
        expression: {
            parse: function(a, c) {
                ...
                c.push({
                    ...
                    name: "expression",
                    expression: b.tree,
                    params: z(a.slice(b.value.length).replace(/^\s+|\s+$/g, ""))
                });
                return b.tree
            },
            process: function(a, c) {
                ...
                if (0 > G(b, "nofilter")) {
                    ...
                    escape_html && (d = H.__escape(d));
                    d = M(varFilters, d);
                    N.length && (__t = function() {
                        return d
                    }
                    ,
                    d = p(N, c))
        ...
        operator: {
            process: function(a, c) {
                ...
                if ("binary" == a.optype) {
                    b = b[1];
                    if ("=" == a.op)
                        return C(a.params.__parsed[0], c, b),
                        "";
                    if (a.op.match(/(\+=|-=|\*=|\/=|%=)/)) {
                        d = C(a.params.__parsed[0], c);
                        switch (a.op) {
                        case "+=":
                            d += b;
                            break;
                        ...
                        return C(a.params.__parsed[0], c, d)
                    }
                    if (a.op.match(/div/))
                    ...
                    if ("!" == a.op)
                        return d instanceof Array ? !d.length : !d;
                    (b = "var" == a.params.__parsed[0].type) && (d = C(a.params.__parsed[0], c));
                    var e = d;
        ...
        section: {
            ...
            parse: function(a, c, b) {
                ...
                (a = K("section [^}]+", "/section", "sectionelse", b)) ? (r(b.slice(0, a.index), d),
            ...
            process: function(a, c) {
                ...
                d.show = e;
                if (!e)
                    return p(a.subTreeElse, c);
                var e = parseInt(b.__get("start", 0))
                  , f = b.loop instanceof Object ? O(b.loop) : isNaN(b.loop) ? 0 : parseInt(b.loop)
                  , g = parseInt(b.__get("step", 1))
                  , b = parseInt(b.__get("max"));
                isNaN(b) && (b = Number.MAX_VALUE);
                0 > e ? (e += f,
                0 > e && (e = 0)) : e >= f && (e = f ? f - 1 : 0);
                for (var l = 0, k = e; 0 <= k && k < f && l < b; k += g,
                ++l)
                    ;
                d.total = l;
                d.loop = l;
                for (var l = 0, h = "", k = e; 0 <= k && k < f && l < b && !c.smarty["break"]; k += g,
                ++l)
                    d.first = k == e,
                    d.last = 0 > k + g || k + g >= f,
                    d.index = k,
                    d.index_prev = k - g,
                    d.index_next = k + g,
                    d.iteration = d.rownum = l + 1,
                    h += p(a.subTree, c),
                    c.smarty["continue"] = !1;
                c.smarty["break"] = !1;
                return l ? h : p(a.subTreeElse, c)
            }
        },
        setfilter: {
            type: "block",
        ...
        "for": {
            ...
            parseParams: function(a) {
                ...
                return z("varName='" + c[1] + "' from=" + c[2] + " to=" + c[3] + " step=" + (c[4] ? c[4] : "1") + " " + c[5])
            },
            parse: function(a, c, b) {
                var d = []
                  , e = [];
                ...
                (a = K("for\\s[^}]+", "/for", "forelse", b)) ? (r(b.slice(0, a.index), d),
            ...
            process: function(a, c) {
                ...
                for (var l = 0, k = "", d = Math.min(Math.ceil(((0 < f ? e - d : d - e) + 1) / Math.abs(f)), g), e = parseInt(b.from); l < d && !c.smarty["break"]; e += f,
                ++l)
                    c[b.varName] = e,
                    k += p(a.subTree, c),
                    c.smarty["continue"] = !1;
                c.smarty["break"] = !1;
                l || (k = p(a.subTreeElse, c));
                return k
            }
        },
        "if": {
            ...
            parse: function(a, c, b) {
                ...
                (a = K("if\\s+[^}]+", "/if", "else[^}]*", b)) ? (r(b.slice(0, a.index), d),
                b = b.slice(a.index + a[0].length),
                (d = a[1].match(/^else\s*if(.*)/)) ? F["if"].parse(z(d[1]), e, b.replace(/^\n/, "")) : r(b.replace(/^\n/, ""), e)) : r(b, d)
            },
            process: function(a, c) {
                var b = y(a.params, c)[0];
                return !b || b instanceof Array && !b.length || b instanceof Object && !O(b) ? p(a.subTreeElse, c) : p(a.subTreeIf, c)
            }
        },
        foreach: {
            type: "block",
            ...
            parse: function(a, c, b) {
                ...
                (a = K("foreach\\s[^}]+", "/foreach", "foreachelse", b)) ? (r(b.slice(0, a.index), d),
                r(b.slice(a.index + a[0].length).replace(/^[\r\n]/, ""), e)) : r(b, d)
            },
            process: function(a, c) {
                var b = y(a.params, c)
                ...
                for (l in d)
                    if (d.hasOwnProperty(l)) {
                        if (c.smarty["break"])
                            break;
                        c[b.item + "__key"] = isNaN(l) ? l : parseInt(l);
                ...
                return 0 < g ? f : p(a.subTreeElse, c)
            }
        },
        "function": {
            type: "block",
            parse: function(a, c, b) {
                c = [];
                A[E(a.name ? a.name : a[0])] = {
                    type: "function",
                    subTree: c,
                    defautParams: a,
                    process: function(a, b) {
                        var c = y(this.defautParams, b);
                        delete c.name;
                        return p(this.subTree, J({}, b, c, a))
                    }
                };
                r(b, c)
            }
        ...
        block: {
            ...
            parse: function(a, c, b) {
                ...
                a.append = 0 <= G(a, "append");
                a.prepend = 0 <= G(a, "prepend");
                a.hide = 0 <= G(a, "hide");
            ...
            process: function(a, c) {
                ...
                var b = E(a.params.name ? a.params.name : a.params[0]);
                this.processBlocks(D[b], D[b].length - 1, c);
        ...
        ldelim: {
            type: "function",
            parse: function(a, c) {
                w(jSmart.prototype.left_delimiter, c)
            }
        },
        rdelim: {
            type: "function",
            parse: function(a, c) {
                w(jSmart.prototype.right_delimiter, c)
            }
        },
        "while": {
            type: "block",
            ...
            process: function(a, c) {
                for (var b = ""; y(a.params, c)[0] && !c.smarty["break"]; )
                    b += p(a.subTree, c),
                    c.smarty["continue"] = !1;
                c.smarty["break"] = !1;
                return b
      ...
      , L = [{
        ...
        re: /^(true|false)/i,
        parse: function(a, c) {
            w(a.token.match(/true/i) ? "1" : "", a.tree)
        }
    }, {
        re: /^'([^'\\]*(?:\\.[^'\\]*)*)'/,
        parse: function(a, c) {
    ...
    jSmart = function(a) {
        ...
        D = this.tree.blocks;
        r(M(jSmart.prototype.filters_global.pre, ba((new String(a ? a : "")).replace(/\r\n/g, "\n"))), this.tree)
    }
    ;
    jSmart.prototype.fetch = function(a) {
        ...
        this.data = J("object" == typeof a ? a : {}, this.smarty);
        varFilters = jSmart.prototype.filters_global.variable.concat(this.filters.variable);
        a = p(this.tree, this.data);
        jSmart.prototype.debugging && A.debug.process([], this.data);
        return M(jSmart.prototype.filters_global.post.concat(this.filters.post), a)
    }
    ;
    jSmart.prototype.escape_html = !1;
    jSmart.prototype.registerPlugin = function(a, c, b) {
        "modifier" == a ? H["__" + c] = b : A[c] = {
            type: a,
            process: b
        }
    }
    ;
    jSmart.prototype.registerFilter = function(a, c) {
        (this.tree ? this.filters : jSmart.prototype.filters_global)["output" == a ? "post" : a].push(c)
    }
    ;
    ...
    jSmart.prototype.configLoad = function(a, c, b) {
        b = b ? b : this.data;
        a = a.replace(/\r\n/g, "\n").replace(/^\s+|\s+$/g, "");
    ...
    jSmart.prototype.registerPlugin("function", "__array", function(a, c) {
        var b = [], d;
        for (d in a)
            a.hasOwnProperty(d) && a[d] && "function" != typeof a[d] && (b[d] = a[d]);
        return b
    });
    jSmart.prototype.registerPlugin("function", "__func", function(a, c) {
        for (var b = [], d = {}, e = 0; e < a.length; ++e)
            b.push(a.name + "__p" + e),
            d[a.name + "__p" + e] = a[e];
        return R(("__owner"in c && a.name in c.__owner ? "__owner." + a.name : a.name) + "(" + b.join(",") + ")", J({}, c, d))
    });
    jSmart.prototype.registerPlugin("function", "__quoted", function(a, c) {
        return a.join("")
    });
    jSmart.prototype.registerPlugin("function", "break", function(a, c) {
        c.smarty["break"] = !0;
        return ""
    });
    jSmart.prototype.registerPlugin("function", "continue", function(a, c) {
        c.smarty["continue"] = !0;
        return ""
    });
    jSmart.prototype.registerPlugin("function", "call", function(a, c) {
    ...
    jSmart.prototype.registerPlugin("function", "append", function(a, c) {
    ...
    jSmart.prototype.registerPlugin("function", "assign", function(a, c) {
        x(a.__get("var", null, 0), a.__get("value", null, 1), c);
        return ""
    });
    jSmart.prototype.registerPlugin("block", "capture", function(a, c, b, d) {
        c && (c = c.replace(/^\n/, ""),
        b.smarty.capture[a.__get("name", "default", 0)] = c,
        "assign"in a && x(a.assign, c, b),
        (a = a.__get("append", !1)) && (a in b ? b[a]instanceof Array && b[a].push(c) : b[a] = [c]));
        return ""
    });
    jSmart.prototype.registerPlugin("function", "eval", function(a, c) {
        var b = [];
        r(a.__get("var", "", 0), b);
        b = p(b, c);
        return "assign"in a ? (x(a.assign, b, c),
        "") : b
    });
    jSmart.prototype.registerPlugin("function", "include", function(a, c) {
        var b = a.__get("file", null, 0)
          , d = J({}, c, a);
        d.smarty.template = b;
        b = p(aa(b, [], 0 <= G(a, "nocache")), d);
        return "assign"in a ? (x(a.assign, b, c),
        "") : b
    });
    jSmart.prototype.registerPlugin("block", "nocache", function(a, c, b, d) {
        return c
    });
    jSmart.prototype.registerPlugin("block", "javascript", function(a, c, b, d) {
        b.$this = b;
        R(c, b);
        delete b.$this;
        return ""
    });
    jSmart.prototype.registerPlugin("function", "config_load", function(a, c) {
        jSmart.prototype.configLoad(jSmart.prototype.getConfig(a.__get("file", null, 0)), a.__get("section", "", 1), c);
        return ""
    });
    jSmart.prototype.registerPlugin("modifier", "defaultValue", function(a, c) {
    ...
    ;
    jSmart.prototype.registerPlugin("function", "counter", function(a, c) {
    ...
    jSmart.prototype.registerPlugin("function", "cycle", function(a, c) {
        var b = a.__get("name", "default")
          , d = a.__get("reset", !1);
        ...
        if (c.smarty.cycle[b].index >= c.smarty.cycle[b].arr.length || d)
            c.smarty.cycle[b].index = 0;
        return a.__get("assign", !1) ? (x(a.assign, c.smarty.cycle[b].arr[c.smarty.cycle[b].index], c),
        "") : a.__get("print", !0) ? c.smarty.cycle[b].arr[c.smarty.cycle[b].index] : ""
    });
    jSmart.prototype.print_r = function(a, c) {
        if (a instanceof Object) {
            var b = (a instanceof Array ? "Array[" + a.length + "]" : "Object") + "<br>", d;
            for (d in a)
                a.hasOwnProperty(d) && (b += c + "&nbsp;&nbsp;<strong>" + d + "</strong> : " + jSmart.prototype.print_r(a[d], c + "&nbsp;&nbsp;&nbsp;") + "<br>");
            return b
        }
        return a
    }
    ;
    jSmart.prototype.registerPlugin("function", "debug", function(a, c) {
        "undefined" != typeof dbgWnd && dbgWnd.close();
        dbgWnd = window.open("", "", "width=680,height=600,resizable,scrollbars=yes");
        var b = "", d = 0, e;
        for (e in c)
            b += "<tr class=" + (++d % 2 ? "odd" : "even") + "><td><strong>" + e + "</strong></td><td>" + jSmart.prototype.print_r(c[e], "") + "</td></tr>";
    ...
    jSmart.prototype.registerPlugin("function", "fetch", function(a, c) {
        var b = jSmart.prototype.getFile(a.__get("file", null, 0));
        return "assign"in a ? (x(a.assign, b, c),
        "") : b
    });
    jSmart.prototype.registerPlugin("function", "insert", function(a, c) {
        var b = {}, d;
        for (d in a)
    ...
    jSmart.prototype.registerPlugin("function", "html_checkboxes", function(a, c) {
        var b = a.__get("type", "checkbox")
          , d = a.__get("name", b);
        "checkbox" == b && (d += "[]");
        var e = a.__get("values", a.options), f = a.__get("options", []), g = "options"in a, l;
        if (!g)
            for (l in a.output)
                f.push(a.output[l]);
        var k = a.__get("selected", !1)
          , h = a.__get("separator", "")
          , q = Boolean(a.__get("labels", !0))
          , n = []
          , X = 0
          , v = "";
        for (l in e)
            e.hasOwnProperty(l) && (v = q ? "<label>" : "",
            v += '<input type="' + b + '" name="' + d + '" value="' + (g ? l : e[l]) + '" ',
            k == (g ? l : e[l]) && (v += 'checked="checked" '),
            v += "/>" + f[g ? l : X++],
            v += q ? "</label>" : "",
            v += h,
            n.push(v));
        return "assign"in a ? (x(a.assign, n, c),
        "") : n.join("\n")
    });
    jSmart.prototype.registerPlugin("function", "html_image", function(a, c) {
        var b = a.__get("file", null), d = a.__get("width", !1), e = a.__get("height", !1), f = a.__get("alt", ""), g = a.__get("href", !1), l = {
            file: 1,
            width: 1,
            height: 1,
            alt: 1,
            ...
            basedir: 1,
            path_prefix: 1
        }, b = '<img src="' + a.__get("path_prefix", "") + b + '" alt="' + f + '"' + (d ? ' width="' + d + '"' : "") + (e ? ' height="' + e + '"' : ""), k;
        for (k in a)
            a.hasOwnProperty(k) && "string" == typeof a[k] && (k in l || (b += " " + k + '="' + a[k] + '"'));
        b += " />";
        return g ? '<a href="' + g + '">' + b + "</a>" : b
    });
    jSmart.prototype.registerPlugin("function", "html_options", function(a, c) {
        ...
        var g = a.__get("selected", !1)
          ...
          , h = 0;
        for (f in b)
            b.hasOwnProperty(f) && (k = '<option value="' + (e ? f : b[f]) + '"',
            g == (e ? f : b[f]) && (k += ' selected="selected"'),
            k += ">" + d[e ? f : h++] + "</option>",
            l.push(k));
        b = a.__get("name", !1);
        return (b ? '<select name="' + b + '">\n' + l.join("\n") + "\n</select>" : l.join("\n")) + "\n"
    });
    jSmart.prototype.registerPlugin("function", "html_radios", function(a, c) {
        a.type = "radio";
        return A.html_checkboxes.process(a, c)
    });
    jSmart.prototype.registerPlugin("function", "html_select_date", function(a, c) {
    ...
    jSmart.prototype.registerPlugin("function", "html_table", function(a, c) {
        var b = [], d;
        ...
        var e = e ? e : Math.ceil(b.length / f)
          , l = a.__get("inner", "cols");
        d = a.__get("caption", "");
        var k = a.__get("table_attr", 'border="1"')
          , h = a.__get("th_attr", !1);
        h && "object" != typeof h && (h = [h]);
        var q = a.__get("tr_attr", !1);
        q && "object" != typeof q && (q = [q]);
        var n = a.__get("td_attr", !1);
        n && "object" != typeof n && (n = [n]);
        for (var X = a.__get("trailpad", "&nbsp;"), v = a.__get("hdir", "right"), m = a.__get("vdir", "down"), p = "", r = 0; r < e; ++r) {
            for (var p = p + ("<tr" + (q ? " " + q[r % q.length] : "") + ">\n"), t = 0; t < f; ++t)
                var u = "cols" == l ? ("down" == m ? r : e - 1 - r) * f + ("right" == v ? t : f - 1 - t) : ("right" == v ? t : f - 1 - t) * e + ("down" == m ? r : e - 1 - r)
                  , p = p + ("<td" + (n ? " " + n[t % n.length] : "") + ">" + (u < b.length ? b[u] : X) + "</td>\n");
            p += "</tr>\n"
        }
        b = "";
        if (g.length) {
            ...
            for (e = 0; e < g.length; ++e)
                b += "\n<th" + (h ? " " + h[e % h.length] : "") + ">" + g["right" == v ? e : g.length - 1 - e] + "</th>";
            b += "\n</tr></thead>"
        }
        return "<table " + k + ">" + (d ? "\n<caption>" + d + "</caption>" : "") + b + "\n<tbody>\n" + p + "</tbody>\n</table>\n"
    });
    jSmart.prototype.registerPlugin("function", "include_javascript", function(a, c) {
        var b = a.__get("file", null, 0);
        if (a.__get("once", !0) && b in W)
            return "";
        W[b] = !0;
        b = R(jSmart.prototype.getJavascript(b), {
            $this: c
        });
        return "assign"in a ? (x(a.assign, b, c),
        "") : b
    });
    jSmart.prototype.registerPlugin("function", "include_php", function(a, c) {
        return A.include_javascript.process(a, c)
    });
    m.rawurlencode = function(a) {
        a = (a + "").toString();
        return encodeURIComponent(a).replace(/!/g, "%21").replace(/'/g, "%27").replace(/\(/g, "%28").replace(/\)/g, "%29").replace(/\*/g, "%2A")
    }
    ;
    m.bin2hex = function(a) {
        var c, b, d = "", e;
        a += "";
        c = 0;
    ...
    ;
    jSmart.prototype.registerPlugin("function", "mailto", function(a, c) {
        var b = a.__get("address", null)
          , d = a.__get("encode", "none")
          , e = a.__get("text", b)
          , f = m.rawurlencode(a.__get("cc", "")).replace("%40", "@")
          , g = m.rawurlencode(a.__get("bcc", "")).replace("%40", "@")
          , l = m.rawurlencode(a.__get("followupto", "")).replace("%40", "@")
          , k = m.rawurlencode(a.__get("subject", ""))
          , h = m.rawurlencode(a.__get("newsgroups", ""))
          , q = a.__get("extra", "")
          , b = b + (f ? "?cc=" + f : "") + (g ? (f ? "&" : "?") + "bcc=" + g : "")
          , b = b + (k ? (f || g ? "&" : "?") + "subject=" + k : "")
          , b = b + (h ? (f || g || k ? "&" : "?") + "newsgroups=" + h : "")
          , b = b + (l ? (f || g || k || h ? "&" : "?") + "followupto=" + l : "");
        s = '<a href="mailto:' + b + '" ' + q + ">" + e + "</a>";
        if ("javascript" == d) {
            s = "document.write('" + s + "');";
            e = "";
            for (d = 0; d < s.length; ++d)
                e += "%" + m.bin2hex(s.substr(d, 1));
            return '<script type="text/javascript">eval(unescape(\'' + e + "'))\x3c/script>"
        }
        if ("javascript_charcode" == d) {
            e = [];
            for (d = 0; d < s.length; ++d)
                e.push(m.ord(s.substr(d, 1)));
        ...
        if ("hex" == d) {
            ...
            for (d = 0; d < b.length; ++d)
                f = b.substr(d, 1).match(/\w/) ? f + ("%" + m.bin2hex(b.substr(d, 1))) : f + b.substr(d, 1);
            b = "";
            for (d = 0; d < e.length; ++d)
                b += "&#x" + m.bin2hex(e.substr(d, 1)) + ";";
            return '<a href="&#109;&#97;&#105;&#108;&#116;&#111;&#58;' + f + '" ' + q + ">" + b + "</a>"
        }
        return s
    });
    m.sprintf = function() {
        var a = arguments
          ...
          , d = function(a, c, d, e, h, q) {
            var n = e - a.length;
            0 < n && (a = d || !h ? b(a, e, q, d) : a.slice(0, c.length) + b("", n, "0", !0) + a.slice(c.length));
            return a
        }
          , e = function(a, c, e, k, h, q, n) {
            a >>>= 0;
            e = e && a && {
                2: "0b",
                8: "0",
            ...
            a = e + b(a.toString(c), q || 0, "0", !1);
            return d(a, e, k, h, n)
        };
        return a[c++].replace(/%%|%(\d+\$)?([-+\'#0 ]*)(\*\d+\$|\*|\d+)?(\.(\*\d+\$|\*|\d+))?([scboxXuideEfFgG])/g, function(f, g, l, k, h, q, n) {
            var m, v;
            if ("%%" === f)
                return "%";
            var p = !1;
            ...
            var r = h = !1;
            m = " ";
            for (var t = l.length, u = 0; l && u < t; u++)
                switch (l.charAt(u)) {
                case " ":
                    v = " ";
                    break;
            ...
            q = q ? "*" === q ? +a[c++] : "*" == q.charAt(0) ? +a[q.slice(1, -1)] : +q : -1 < "fFeE".indexOf(n) ? 6 : "d" === n ? 0 : void 0;
            g = g ? a[g.slice(0, -1)] : a[c++];
            switch (n) {
            case "s":
                return n = String(g),
                null != q && (n = n.slice(0, q)),
                d(n, "", p, k, h, m);
            case "c":
                return n = String.fromCharCode(+g),
                null != q && (n = n.slice(0, q)),
                d(n, "", p, k, h, void 0);
            case "b":
                return e(g, 2, r, p, k, q, h);
            case "o":
                return e(g, 8, r, p, k, q, h);
            case "x":
                return e(g, 16, r, p, k, q, h);
            case "X":
                return e(g, 16, r, p, k, q, h).toUpperCase();
            case "u":
                return e(g, 10, r, p, k, q, h);
            case "i":
            case "d":
                return m = +g || 0,
                m = Math.round(m - m % 1),
                f = 0 > m ? "-" : v,
                g = f + b(String(Math.abs(m)), q, "0", !1),
                d(g, f, p, k, h);
            case "e":
            case "E":
            case "f":
            ...
            case "G":
                return m = +g,
                f = 0 > m ? "-" : v,
                v = ["toExponential", "toFixed", "toPrecision"]["efg".indexOf(n.toLowerCase())],
                n = ["toString", "toUpperCase"]["eEfFgG".indexOf(n) % 2],
                g = f + Math.abs(m)[v](q),
                d(g, f, p, k, h)[n]();
            default:
                return f
    ...
    ;
    jSmart.prototype.registerPlugin("function", "math", function(a, c) {
        with (Math)
            with (a)
                var b = eval(a.__get("equation", null).replace(/pi\(\s*\)/g, "PI"));
        "format"in a && (b = m.sprintf(a.format, b));
        return "assign"in a ? (x(a.assign, b, c),
        "") : b
    });
    jSmart.prototype.registerPlugin("modifier", "wordwrap", function(a, c, b, d) {
        c = c || 80;
        b = b || "\n";
        a = (new String(a)).split("\n");
        for (var e = 0; e < a.length; ++e) {
            for (var f = a[e], g = ""; f.length > c; ) {
                for (var l = 0, k = f.slice(l).match(/\s+/); k && l + k.index <= c; k = f.slice(l).match(/\s+/))
                    l += k.index + k[0].length;
                l = l || (d ? c : k ? k.index + k[0].length : f.length);
                g += f.slice(0, l).replace(/\s+$/, "");
                l < f.length && (g += b);
                f = f.slice(l)
            }
            a[e] = g + f
    ...
    jSmart.prototype.registerPlugin("block", "textformat", function(a, c, b, d) {
        if (!c)
            return "";
        c = new String(c);
        d = a.__get("wrap", 80);
        var e = a.__get("wrap_char", "\n")
          ...
          , l = a.__get("indent", 0)
          , k = Array(l + 1).join(g)
          , h = a.__get("indent_first", 0)
          , g = Array(h + 1).join(g);
        "email" == a.__get("style", "") && (d = 72);
        c = c.split("\n");
        for (var q = 0; q < c.length; ++q) {
            var n = c[q];
            n && (n = n.replace(/^\s+|\s+$/, "").replace(/\s+/g, " "),
            h && (n = g + n),
            n = H.__wordwrap(n, d - l, e, f),
            l && (n = n.replace(/^/mg, k)),
            c[q] = n)
        }
        d = c.join(e + e);
        return "assign"in a ? (x(a.assign, d, b),
        "") : d
    });
    jSmart.prototype.registerPlugin("modifier", "capitalize", function(a, c) {
        if ("string" != typeof a)
            return a;
    ...
    jSmart.prototype.registerPlugin("modifier", "cat", function(a, c) {
        c = c ? c : "";
        return new String(a) + c
    });
    jSmart.prototype.registerPlugin("modifier", "count", function(a, c) {
        ...
        for (b in a)
            ...
            c && a[b] && (a[b].constructor === Array || a[b].constructor === Object) && (d += H.__count(a[b], !0)));
        return d
    });
    jSmart.prototype.registerPlugin("modifier", "count_characters", function(a, c) {
        a = new String(a);
    ...
    m.setlocale = function(a, c) {
        var b = ""
          ...
          , f = function n(a) {
            ...
            var b = {}, c;
            for (c in a)
                b[c] = "object" === typeof a[c] ? n(a[c]) : a[c];
            return b
        }
          , g = function(a) {
            return 1 !== a ? 1 : 0
        ...
        h.locales.en_US = f(h.locales.en),
        h.locales.en_US.LC_TIME.c = "%a %d %b %Y %r %Z",
        h.locales.en_US.LC_TIME.x = "%D",
        h.locales.en_US.LC_TIME.X = "%r",
        h.locales.en_US.LC_MONETARY.int_curr_symbol = "USD ",
        h.locales.en_US.LC_MONETARY.p_sign_posn = 1,
        h.locales.en_US.LC_MONETARY.n_sign_posn = 1,
        h.locales.en_US.LC_MONETARY.mon_grouping = [3, 3],
        h.locales.en_US.LC_NUMERIC.thousands_sep = "",
        h.locales.en_US.LC_NUMERIC.grouping = [],
        h.locales.en_GB = f(h.locales.en),
        h.locales.en_GB.LC_TIME.r = "%l:%M:%S %P %Z",
        h.locales.en_AU = f(h.locales.en_GB),
        h.locales.C = f(h.locales.en),
        h.locales.C.LC_CTYPE.CODESET = "ANSI_X3.4-1968",
        h.locales.C.LC_MONETARY = {
            int_curr_symbol: "",
            currency_symbol: "",
            mon_decimal_point: "",
            mon_thousands_sep: "",
        ...
        h.locales.C.LC_NUMERIC = {
            decimal_point: ".",
            thousands_sep: "",
            grouping: []
        },
        h.locales.C.LC_TIME.c = "%a %b %e %H:%M:%S %Y",
        h.locales.C.LC_TIME.x = "%m/%d/%y",
        h.locales.C.LC_TIME.X = "%H:%M:%S",
        h.locales.C.LC_MESSAGES.YESEXPR = "^[yY]",
        h.locales.C.LC_MESSAGES.NOEXPR = "^[nN]",
        h.locales.fr = f(h.locales.en),
        h.locales.fr.nplurals = l,
        h.locales.fr.LC_TIME.a = "dim lun mar mer jeu ven sam".split(" "),
        h.locales.fr.LC_TIME.A = "dimanche lundi mardi mercredi jeudi vendredi samedi".split(" "),
        h.locales.fr.LC_TIME.b = "jan f\u00e9v mar avr mai jun jui ao\u00fb sep oct nov d\u00e9c".split(" "),
        h.locales.fr.LC_TIME.B = "janvier f\u00e9vrier mars avril mai juin juillet ao\u00fbt septembre octobre novembre d\u00e9cembre".split(" "),
        h.locales.fr.LC_TIME.c = "%a %d %b %Y %T %Z",
        h.locales.fr.LC_TIME.p = ["", ""],
        h.locales.fr.LC_TIME.P = ["", ""],
        h.locales.fr.LC_TIME.x = "%d.%m.%Y",
        h.locales.fr.LC_TIME.X = "%T",
        h.locales.fr_CA = f(h.locales.fr),
        h.locales.fr_CA.LC_TIME.x = "%Y-%m-%d");
        h.locale || (h.locale = "en_US",
        e.getElementsByTagNameNS && e.getElementsByTagNameNS("http://www.w3.org/1999/xhtml", "html")[0] ? e.getElementsByTagNameNS("http://www.w3.org/1999/xhtml", "html")[0].getAttributeNS && e.getElementsByTagNameNS("http://www.w3.org/1999/xhtml", "html")[0].getAttributeNS("http://www.w3.org/XML/1998/namespace", "lang") ? h.locale = e.getElementsByTagName("http://www.w3.org/1999/xhtml", "html")[0].getAttributeNS("http://www.w3.org/XML/1998/namespace", "lang") : e.getElementsByTagNameNS("http://www.w3.org/1999/xhtml", "html")[0].lang && (h.locale = e.getElementsByTagNameNS("http://www.w3.org/1999/xhtml", "html")[0].lang) : e.getElementsByTagName("html")[0] && e.getElementsByTagName("html")[0].lang && (h.locale = e.getElementsByTagName("html")[0].lang));
        h.locale = h.locale.replace("-", "_");
        !(h.locale in h.locales) && h.locale.replace(/_[a-zA-Z]+$/, "")in h.locales && (h.locale = h.locale.replace(/_[a-zA-Z]+$/, ""));
        h.localeCategories || (h.localeCategories = {
            LC_COLLATE: h.locale,
            LC_CTYPE: h.locale,
            LC_MONETARY: h.locale,
            LC_NUMERIC: h.locale,
            LC_TIME: h.locale,
            LC_MESSAGES: h.locale
        });
        if (null === c || "" === c)
    ...
    m.strftime = function(a, c) {
        ...
        }, g = "undefined" === typeof c ? new Date : "object" === typeof c ? new Date(c) : new Date(1E3 * c), l = {
            c: "locale",
            D: "%m/%d/%y",
            F: "%y-%m-%d",
            h: "%b",
    ...
    m.strtotime = function(a, c) {
        function b(a) {
            ...
            d && (e *= parseInt(a, 10));
            if (l.hasOwnProperty(c) && !b[1].match(/^mon(day|\.)?$/i))
                return f["set" + l[c]](f["get" + l[c]]() + e);
            if ("wee" === c)
    ...
    ;
    jSmart.prototype.registerPlugin("modifier", "date_format", function(a, c, b) {
        return a ? m.strftime(c ? c : "%b %e, %Y", makeTimeStamp(a ? a : b)) : ""
    });
    m.get_html_translation_table = function(a, c) {
        var b = {}, d = {}, e, f = {}, g = {}, l = {}, k = {};
        ...
        g[2] = "ENT_COMPAT";
        g[3] = "ENT_QUOTES";
        l = isNaN(a) ? a ? a.toUpperCase() : "HTML_SPECIALCHARS" : f[a];
        k = isNaN(c) ? c ? c.toUpperCase() : "ENT_COMPAT" : g[c];
        if ("HTML_SPECIALCHARS" !== l && "HTML_ENTITIES" !== l)
            throw Error("Table: " + l + " not supported");
        b["38"] = "&amp;";
        "HTML_ENTITIES" === l && (b["160"] = "&nbsp;",
        b["161"] = "&iexcl;",
        b["162"] = "&cent;",
        b["163"] = "&pound;",
        b["164"] = "&curren;",
    ...
    ;
    m.htmlentities = function(a, c, b, d) {
    ...
    ;
    jSmart.prototype.registerPlugin("modifier", "escape", function(a, c, b, d) {
        a = new String(a);
        b = b || "UTF-8";
        ...
        case "htmlall":
            return m.htmlentities(a, 3, b);
        case "url":
            return m.rawurlencode(a);
        case "urlpathinfo":
            return m.rawurlencode(a).replace(/%2F/g, "/");
        case "quotes":
            return a.replace(/(^|[^\\])'/g, "$1\\'");
        case "hex":
            c = "";
            for (b = 0; b < a.length; ++b)
                c += "%" + m.bin2hex(a.substr(b, 1));
            return c;
        case "hexentity":
            c = "";
            for (b = 0; b < a.length; ++b)
                c += "&#x" + m.bin2hex(a.substr(b, 1)).toUpperCase() + ";";
            return c;
        case "decentity":
            c = "";
            for (b = 0; b < a.length; ++b)
                c += "&#" + m.ord(a.substr(b, 1)) + ";";
            return c;
        case "mail":
    ...
    jSmart.prototype.registerPlugin("modifier", "indent", function(a, c, b) {
        a = new String(a);
        c = c ? c : 4;
        b = b ? b : " ";
        for (var d = ""; c--; )
    ...
    jSmart.prototype.registerPlugin("modifier", "regex_replace", function(a, c, b) {
        c = c.match(/^ *\/(.*)\/(.*) *$/);
        return (new String(a)).replace(RegExp(c[1], "g" + (1 < c.length ? c[2] : "")), b)
    });
    jSmart.prototype.registerPlugin("modifier", "replace", function(a, c, b) {
        if (!c)
            return a;
        a = new String(a);
        c = new String(c);
    ...
    jSmart.prototype.registerPlugin("modifier", "spacify", function(a, c) {
        c || (c = " ");
        return (new String(a)).replace(/(\n|.)(?!$)/g, "$1" + c)
    });
    jSmart.prototype.registerPlugin("modifier", "string_format", function(a, c) {
        return m.sprintf(c, a)
    });
    jSmart.prototype.registerPlugin("modifier", "strip", function(a, c) {
        c = c ? c : " ";
        return (new String(a)).replace(/[\s]+/g, c)
    });
    jSmart.prototype.registerPlugin("modifier", "strip_tags", function(a, c) {
        c = null == c ? !0 : c;
        return (new String(a)).replace(/<[^>]*?>/g, c ? " " : "")
    });
    jSmart.prototype.registerPlugin("modifier", "truncate", function(a, c, b, d, e) {
        a = new String(a);
        c = c ? c : 80;
        b = null != b ? b : "...";
        if (a.length <= c)
...
jSmart.prototype.registerPlugin('modifier', 'ceil', function(nums) {
